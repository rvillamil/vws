...
- [VWS: Video websites scraper](#vws-video-websites-scraper)
    ...
    - [Arquitectura de desarrollo](#arquitectura-de-desarrollo)
        ...
        - [Pipeline: Integracion con Jenkins pipeline](#pipeline-integracion-con-jenkins-pipeline)
        - [Pipeline: Integracion con Bitbucket pipeline](#pipeline-integracion-con-bitbucket-pipeline)
        - [Arquitectura de desarrollo del módulo de FrontEnd](#arquitectura-de-desarrollo-del-m%C3%B3dulo-de-frontend)
            - [Tecnologías frontend](#tecnolog%C3%ADas-frontend)
            - [Layout del 'frontend'](#layout-del-frontend)
            - [Proceso de desarrollo para un 'Frontend Developer'](#proceso-de-desarrollo-para-un-frontend-developer)
        - [Arquitectura de desarrollo de los móduloS de Backend](#arquitectura-de-desarrollo-de-los-m%C3%B3dulos-de-backend)
            - [Tecnologias backend](#tecnologias-backend)
            - [Layout de la aplicacion backend](#layout-de-la-aplicacion-backend)
        ...
        - [Arquitectura de desarrollo de la BB.DD](#arquitectura-de-desarrollo-de-la-bbdd)
...
### Pipeline: Integracion con Jenkins pipeline  ###
### Pipeline: Integracion con Bitbucket pipeline  ###
// TODO

### Arquitectura de desarrollo del módulo de FrontEnd ###
...
### Arquitectura de desarrollo de los móduloS de Backend ###
#### Tecnologias backend ####
...
#### Layout de la aplicacion backend ####
...
### Arquitectura de desarrollo de la BB.DD ###
